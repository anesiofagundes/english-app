...
export default async function LessonPage({ params }: Props) {
  ...
  return (
    <main className="max-w-2xl mx-auto">
      <div className="bg-gradient-to-b from-cyan-50 to-slate-50 dark:from-slate-800/80 dark:to-slate-900 px-4 pt-8 pb-5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <span className="w-7 h-7 rounded-lg bg-cyan-500 text-white text-xs font-bold flex items-center justify-center flex-shrink-0 shadow-sm">
                {text.id}
              </span>
